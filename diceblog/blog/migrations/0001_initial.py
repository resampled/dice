    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('publish_date', models.DateTimeField(default=blog.models.make_order)),
                ('id', models.SlugField(default='ik7ps55i', primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('publish_date', models.DateTimeField(default=blog.models.make_order)),
                ('id', models.SlugField(default='hg30ksgxp9k7vvijg2', primary_key=True, serialize=False, unique=True)),
                ('author', models.ForeignKey(null=True, on_delete=django.db.models.deletion.RESTRICT, to=settings.AUTH_USER_MODEL)),
